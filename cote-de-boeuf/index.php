...
<body>
	<article class="recipe">
		...
		<aside>
			<h2>Ingredients</h2>
			<ul>
				<li><span class="item-1">One or more 1.5 to 2 kilo pieces of côte de bœuf</span></li>
				<li><span class="item-2">Olive oil</span></li>
				<li><span class="item-3">A few garlic cloves</span></li>
				<li><span class="item-4">Thyme</span></li>
				<li><span class="item-5">Pepper</span></li>
				<li><span class="item-6">Salt</span></li>
			</ul>
		</aside>
		<div>
			<h2>Prep</h2>
			<p>Preheat the waterbath to 53.5°C.</p>
