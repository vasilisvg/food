...
<body>
	<article class="recipe">
		...
		<aside>
			<h2>Ingredients</h2>
			<ul>
				<li><span class="item-1">Butter</span></li>
				<li><span class="item-2">1 chopped onion</span></li>
				<li><span class="item-3">Some chopped carrots</span></li>
				<li><span class="item-4">1 cup of red lentils</span></li>
				<li><span class="item-5">5 cups of chicken broth</span></li>
				<li><span class="item-6">1/2 tablespoon of cumin</span></li>
				<li><span class="item-7">1 tablespoon of paprika powder</span></li>
				<li><span class="item-8">Pepper</span></li>
				<li><span class="item-9">Salt</span></li>
				<li><span class="item-10">Lemon</span></li>
			</ul>
		</aside>
		<div>
			<h2>What?</h2>
			...
			<p>Chop the <span class="item-2">onion</span> and the <span class="item-3">carrots</span> finely (I use a machine).</p>

			<p>Skim the layer of fat off the <span class="item-5">broth</span>.</p>
