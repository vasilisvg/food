...
<body>
	<article class="recipe">
		...
		<aside>
			<h2>Ingredients</h2>
			<ul>
				<li><span class="item-1">1 large dorade</span></li>
				<li><span class="item-2">A lot of salt</span></li>
			</ul>
		</aside>
		<div>
			<h2>Prep</h2>
			...
			<p>I always use a stainless steal fish basket so it doesn't stick to the grate. And this way my friends who eat halal can eat the fish as well, while the rest of my friends eat <a href="../drunken-pig/">drunken pig</a> and <a href="../hamburgers/">hamburgers</a> from the same bbq.</p>
		</div>
	</article>
